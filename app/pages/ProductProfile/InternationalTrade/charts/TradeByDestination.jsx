...
class TradeByDestination extends Section {
  static need = [
    (params, store) => {
      ...
      const prm2 = mondrianClient.cube("exports").then(cube => {
        var q2 = levelCut(
          product,
          "Export HS",
          "HS",
        ...
        return {
          ...
          data: store.env.CANON_API + q2.path("jsonrecords")
        };
      });
...
export default translate()(TradeByDestination);
